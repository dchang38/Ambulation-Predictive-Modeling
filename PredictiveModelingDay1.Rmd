...
rf <- randomForest(afterDay3 ~ days2Transfer + dayTransferred + numWalksDay1 + disWalksDay1 + totalTimeDay1 + averageSpeedDay1 + maxSpeedDay1, data = train, ntree = 500, importance = TRUE)

predictions <- predict(rf, test[predictorColumns], nodes = FALSE)
hist((test$afterDay3 - predictions), breaks=10, main = 'Predictions (1 Day of Data)')
#print(predictions - test$afterDay3)
#print(predictions)
df11$predictions = predictions
plot(rf)
varImpPlot(rf)
plot(predictions, (test$afterDay3 - predictions), main = 'Spread (1 Day of Data)')
...
fit <- rpart(predictions ~ days2Transfer + dayTransferred + numWalksDay1 + + disWalksDay1 + totalTimeDay1 + averageSpeedDay1 + maxSpeedDay1, 
...
rpart.plot(fit, uniform=TRUE,
   main="Regression Tree for Transfer After Day 3 (1 Day of Data)")
