...
df11 <- data.frame(id=c(patientInfo$stringPatient_ID),
                  afterDay3= c(patientInfo$total - 3),
                  hours2Transfer=c(patientInfo$a2i + patientInfo$icuDay),
...
predictorColumns <- c("hours2Transfer", "dayTransferred", "numWalksDay1", "disWalksDay1", "numWalksDay2", "disWalksDay2", "numWalksDay3", "disWalksDay3")
rf <- randomForest(afterDay3 ~ hours2Transfer + dayTransferred + numWalksDay1 + disWalksDay1 + numWalksDay2 + disWalksDay2 + numWalksDay3 + disWalksDay3, data = train, ntree=100, importance = TRUE)
print(rf)
