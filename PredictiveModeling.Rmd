  ...
  for (x in 1:795){
    ...
    if (strtoi(patientInfo$patient_ID[i]) == historical$patient_ID[x]){
      ...
      if (historical$Day.on.Unit[x] == 1) {
        ...
        maxSpeedDay1 <- c(maxSpeedDay1, historical$speed)
        ...
        maxSpeedDay2 <- c(maxSpeedDay2, historical$speed)
        ...
        maxSpeedDay3 <- c(maxSpeedDay3, historical$speed)
...
df11 <- df11[-c(3,5,8,14,15,34,43,44,48,101), ]
...
predictorColumns <- c("days2Transfer", "dayTransferred", "numWalksDay1", "disWalksDay1", "numWalksDay2", "disWalksDay2", "numWalksDay3", "disWalksDay3")
rf <- randomForest(afterDay3 ~ days2Transfer + dayTransferred + numWalksDay1 + disWalksDay1 + numWalksDay2 + disWalksDay2 + numWalksDay3 + disWalksDay3, data = train, ntree=100, importance = TRUE)
...
par <- partial(rf, pred.var = c("dayTransferred", "disWalksDay2"), chull = TRUE)
