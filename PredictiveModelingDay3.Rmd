...
patientInfo$a2t <- (as.Date(transferDays, format="%m/%d/%Y") - as.Date(admissionDays, format="%m/%d/%Y"))
...
print(strtoi(patientInfo$a2t[1]) > patientInfo$icuDay[1])
for (i in 1:82){
  if (strtoi(patientInfo$a2t[i])>patientInfo$icuDay[i]){
    patientInfo$a2i[i] <- strtoi(patientInfo$a2t[i]) - patientInfo$icuDay[i]
